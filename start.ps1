...
# 设置窗口标题
$Host.UI.RawUI.WindowTitle = "Arina AV Downloader - 启动中..."

# 清屏并显示标题
Clear-Host
Write-Host ""
Write-Host "========================================" -ForegroundColor Blue
Write-Host "   🌸 Arina AV Downloader" -ForegroundColor Blue
...
function Main {
    try {
        ...
        Write-Host ""
        Write-Host "👋 感谢使用 Arina AV Downloader" -ForegroundColor Green
